 ...
 * 
 * @author Nick Foster & Shannon Mellin
 * @date October 2017
 **/
...
public class Queens {
	...
	/**
	 * Solves Eight Queens problem. Precondition: Empty game board Postcondition: If
	 * a solution is found, each row of the board contains one queen where queens
	 * are non-attacking, and method returns true; otherwise, returns false (no
	 * solution exists for a queen anywhere in row specified) and the board is
	 * empty.
	 */
	...
	/**
	 * Places queens in row of the board beginning at the specified row. Queens are
	 * placed using the recursive backtracking algorithm.
	 * 
	 ...
	 * queen and method returns true; otherwise, returns false (no solution exists
	 * for a queen anywhere in row specified).
	 * 
	 * @param row
	 * @return
	 */
	 ...
	 * Queen under attack.
	 * 
	 * This method must check if a Queen placed at the specified row:column is under
	 * attack by another Queen in the same column, left-diagonal, or right diagonal.
	 * 
	 * @param row
